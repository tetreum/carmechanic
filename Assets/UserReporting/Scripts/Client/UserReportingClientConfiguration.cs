namespace Unity.Cloud.UserReporting.Client
{
    ...
    public class UserReportingClientConfiguration
    {
        ...
        /// <param name="framesPerMeasure">
        ///     The number of frames per measure. A user report is only created on the boundary between
        ///     measures. A large number of frames per measure will increase user report creation time by this number of frames in
        ///     the worst case.
        /// </param>
        /// <param name="maximumScreenshotCount">The maximum screenshot count. This is a rolling window.</param>
        public UserReportingClientConfiguration(int maximumEventCount, int maximumMeasureCount, int framesPerMeasure,
        ...
        /// </param>
        /// <param name="maximumScreenshotCount">The maximum screenshot count. This is a rolling window.</param>
        public UserReportingClientConfiguration(int maximumEventCount, MetricsGatheringMode metricsGatheringMode,
            int maximumMeasureCount, int framesPerMeasure, int maximumScreenshotCount)
        {
            MaximumEventCount = maximumEventCount;
