...
namespace Unity.Cloud.UserReporting
{
    ...
    public class UserReportPreview
    {
        ...
        /// <summary>
        ///     Gets or sets the time at which the user report expires. This property will be overwritten by the server if
        ///     provided.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether the user report is hidden in the UI if a dimension filter is not specified.
        ///     This is recommended for automated or high volume reports.
        /// </summary>
        public bool IsHiddenWithoutDimension { get; set; }

        /// <summary>
        ///     Gets or sets a value indicating whether the user report is silent. Silent user reports do not send events to
        ///     integrations. This is recommended for automated or high volume reports.
        /// </summary>
        public bool IsSilent { get; set; }

        /// <summary>
        ///     Gets or sets a value indicating whether the user report is temporary. Temporary user reports are short lived and
        ///     not queryable.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the time at which the user report was received. This property will be overwritten by the server if
        ///     provided.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the thumbnail. This screenshot will be resized by the server if too large. Keep the last screenshot
        ///     small in order to reduce report size and increase submission speed.
        /// </summary>
