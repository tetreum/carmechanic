...
namespace Unity.Cloud.UserReporting.Client
{
    ...
    public interface IUserReportingPlatform
    {
        ...
        /// <param name="callback">
        ///     The callback. Provides a value indicating whether the post was successful and provides the
        ///     resulting byte array.
        /// </param>
        void Post(string endpoint, string contentType, byte[] content, Action<float, float> progressCallback,
        ...
        void TakeScreenshot(int frameNumber, int maximumWidth, int maximumHeight, object source,
