...
namespace Unity.Cloud.UserReporting
{
    ...
    public static class AttachmentExtensions
    {
        ...
        public static void AddJson(this List<UserReportAttachment> instance, string name, string fileName,
            string contents)
        {
            if (instance != null)
                instance.Add(new UserReportAttachment(name, fileName, "application/json",
        ...
        /// <param name="fileName">The file name.</param>
        /// <param name="contents">The contents.</param>
        public static void AddText(this List<UserReportAttachment> instance, string name, string fileName,
            string contents)
        {
            if (instance != null)
