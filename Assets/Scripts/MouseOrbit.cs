...
public class MouseOrbit : MonoBehaviour
{
	...
	int yMinLimit= -20; // y minimum rotation limit
	int yMaxLimit= 80;  // y maximum rotation limit
	
	private float x= 0.0f;
	private float y= 0.0f;
	
	private float smooth = 0.0f;
	private float oldScrollValue = 0f;
	...
	void LateUpdate ()
	{
		...
		Vector3 position = rotation * new Vector3(0.0f, 0.5f, -distance) + target.position;
